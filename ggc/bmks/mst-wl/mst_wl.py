...
ast = Module([
               ...
               [CBlock(""),
                ForAll("wlnode", WL.items(), 
                       [CDecl([("int", "node", ""),
                        ...
                        For("edge", G.edges("node"), # maybe a ForAllReduce
                               [
                        ...
                        If("minwt != INF", 
                           ...
                           [If("cs.isBoss(node) && degree", [WL.push("node")], [])]),
                        ]) # forall
        ]),
        ...
        Kernel("gg_main", [GraphParam('hg', True), GraphParam('gg', True)], 
               [
                ...
                CDecl(("LockArray", "complocks", "(hg.nnodes)")),
                CDecl([("int", "level", "= 1"), ("int", "mw", "= 0"), ("int", "last_mw", "= 0")]),
                Pipe([
                        Invoke('init_wl',['gg']),
                        Pipe([CBlock(["last_mw = mw"]),
                              Invoke('find_comp_min_elem', ['gg', 'comp', 'complocks', 'cs', 'level']),
                              #WL.print_size("level"),
