...
class pr_residual_wl(irgl_bmk):
	bmk = 'pr'
	variant = 'residual-wl'

	def filter_inputs(self, inputs):
		return [x for x in inputs if x.props.format == 'bin/galois' and ('symmetric' in x.props.flags or len(x.props.flags) == 0)]
