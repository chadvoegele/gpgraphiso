...
class mis_irgl_pannotia(irgl_bmk):
	bmk = 'mis'
	variant = 'irgl-pannotia'
	...
	def get_run_spec(self, bmkinput):
		...
		x.set_checker(bmk2.ExternalChecker(get_mis_checker(bmkinput.props.file, path = self.props._cwd)))
